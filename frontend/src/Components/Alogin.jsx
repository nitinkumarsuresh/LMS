    ...
    const login = async (e) => {
        ...
        // {
            try {
                ...
                const response = await fetch("http://localhost:8800/adminlogin", {
                    method: "POST",
                    headers: {
                ...
                if (response.ok) {
                    ...
                    console.log(email +"SSS " +data.token);
                    ...
                    // const userDetailsResponse = await fetch(`http://localhost:8800/detailsadmin?email=${email}`);
    ...
    return(
      <div>
        ...
        <div className='container' >
            ...
            <h2 style={{color:'darkblue'}}>LMS Administration</h2>
